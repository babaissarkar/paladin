...
public class Infofield implements ActionListener {
	...
	private final String[] civlities = {"Raenid", "Asarn", "Niaz", "Zivar", "Mayarth", "Kshiti"};
...
//			}
	...
	public void setDeck(Deque<Card> deck2) {
		this.deck = deck2;
		update();
	}
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == grab)  {
			...
			if (lsCards.size() > 0) {
				...
				lsCards.remove(serialNo);
				cl.setCard(curCard);
				cl.setMoved(true);
				setDeck(new ArrayDeque<Card>(lsCards));
			}
		}
	// ToDo
	}
