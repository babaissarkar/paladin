...
//		ImageIcon img = null;
//		try {
//			img = new ImageIcon(cod.decode((encodedText.getBytes())));
...
//	}
//	
//	public static String encode(File selImage) {
...
//				out.flush();
//				try {
//					outstring = new String(cod.encode(out.toByteArray()));
...
//	public static String encode(BufferedImage bimg) {
//		String outstring = null;
//		if (bimg != null) {
//			try {
//				ByteArrayOutputStream out = new ByteArrayOutputStream();
...
//		g.setFont(new Font("URW Palladio L", Font.PLAIN, 26));
		...
		g.drawString("Subhraman Sarkar", width - 150, height - 45);
		g.dispose();
//		showImage(cim);
