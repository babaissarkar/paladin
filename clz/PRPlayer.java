...
public class PRPlayer extends JFrame implements ActionListener {
	...
	private JMenuItem jpiShuffle, jpiSearch, jpiFlip, jpiDraw, jpiLook, jpiFlipVert,
		jpiView, jpiViewCard, jpiToLibrary, jpiToBottom, jpiRemove, jpiToLibBottom, jpiToGrave;
...
//						PRPlayer.newInstance();
	...
	public static Deck shuffle(Deque<Card> d) {
		Random r = new Random();
